...
The in-sample dataset of eleven funds was assembled by selecting
...
paper sample (11 funds) and the full universe (40 funds) respectively.
...
paper's the temporal cluster analysis between 2013 and 2018 can
...
(versus $0.37$ for the 11 in-sample funds).
...
centroids are estimated from the 11 in-sample funds, and the OOS
...
\caption{\label{tab:corrected_fracs}
  ...
  \textit{Paper}: 11 in-sample funds (original the temporal cluster analysis).
...
\begin{figure}[htbp]
  ...
  \caption{\label{fig:full_universe}
    ...
    \textit{(a)} Paper-sample cluster fractions (11 funds),
